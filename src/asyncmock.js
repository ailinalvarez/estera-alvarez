...
const myProducts = [
    ...
    { id: 2, title: "Carpet Gaming", stock: 1, size: "80 x 45 cm", description: "Add color to your floor or wall with this unique, stylish and patterned rug! Specially made for kids play room.", price: 2450, img: "src/assets/Img/productos/alfombra2.png" },
...
export const getOneProduct = (id) => {
    return new Promise(resolve => {
        setTimeout(() => {
            const producto = myProducts.find(item => item.id === id)
            resolve(producto)
        }, 2000)
    })
}